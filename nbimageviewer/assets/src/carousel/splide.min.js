 ...
 */ !(function (e) {
  ...
  function (t, n, e) {
    ...
    function c(t, n) {
      return t
        ? g(t.children).filter(function (t) {
            return M(t, n.split(' ')[0]) || t.tagName === n;
          })
        : [];
    }
    function f(t, n) {
      ...
      var r = {
        ...
        register: function (t, n, e) {
          ...
          function l(t, n) {
            ...
            t
              ? (C(s, i), o.emit(e, c))
              : M(s, i) && (I(s, i), o.emit(n ? 'hidden' : 'inactive', c));
          }
          function f() {
            O(s, 'style', c.styles);
          }
    ...
    function tt(o, t) {
      ...
      function u(t) {
        var n = t.cloneNode(!0);
        return C(n, o.classes.clone), z(n, 'id'), n;
      }
      return e;
    }
    var nt = (function () {
    ...
    function ft(o, r, s) {
      ...
      return {
        ...
        destroy: function () {
          z([a, u], 'disabled'), t && E(a.parentElement);
        },
      };
    }
    function ht(s, n, r) {
    ...
    function pt(a, e) {
      ...
      function n(t, n) {
        O(t, St, !n), a.options.slideFocus && O(t, Pt, n ? 0 : -1);
      }
      function t(t, n) {
        var e = i.track.id;
        O(t, Et, e), O(n, Et, e);
      ...
      function s(t, n) {
        n && O(n.button, _t, !0),
          t.items.forEach(function (t) {
            ...
            O(i, Et, o.join(' ')), O(i, kt, e);
          });
      }
      function c(t, n, e) {
        n && z(n.button, _t), e && O(e.button, _t, !0);
      }
      function d(s) {
        i.each(function (t) {
          var n = t.slide,
      ...
      return {
        ...
        destroy: function () {
          var t = e.Arrows,
            n = t ? t.arrows : {};
          z(i.slides.concat([n.prev, n.next, i.play, i.pause]), o);
        },
      };
    }
    var gt = Math.abs,
            ...
            mount: function () {
              o.on('mounted updated', function () {
                var t = o.options,
                  ...
                  e = Ct[t.direction],
                  i = t.keyboard;
                r && (o.off('keydown', r), z(n, Pt)),
                  i &&
                    ('focused' === i ? O((r = n), Pt, 0) : (r = document),
                    o.on(
                      'keydown',
                      function (t) {
